...
class Cloud extends ex_class implements CreateDB
{
    ...
    public function CreateDB()
    {
        ...
        $info["cloudfiles"]   = [
            ...
            "md5" => [ 'type' => 'varchar(150)', 'null' => 'NOT NULL' ],
        ];
        $info["clouds_vdisk"] = [
            "id"         => [ 'type' => 'int(15)', 'null' => 'NOT NULL', 'inc' => true ],
            "dirmd5"     => [ 'type' => 'varchar(50)', 'null' => 'NOT NULL' ],
            "isdir"      => [ 'type' => 'int(1)', 'null' => 'NOT NULL' ],
            "name"       => [ 'type' => 'varchar(150)', 'null' => 'NOT NULL' ],
            "ext"        => [ 'type' => 'varchar(15)', 'null' => 'NOT NULL' ],
            "createdate" => [ 'type' => 'datetime', 'null' => 'NOT NULL' ],
            "md5"        => [ 'type' => 'varchar(50)', 'null' => 'NOT NULL' ],
            "serverid"   => [ 'type' => 'int(15)', 'null' => 'NOT NULL' ],
        ];
        
        $info["clouds_vservers"] = [
            "id"    => [ 'type' => 'int(11)', 'null' => 'NOT NULL', 'inc' => true ],
            "patch" => [ 'type' => 'varchar(150)', 'null' => 'NOT NULL' ],
        ];
        
        
        $info["clouds_vpaths"] = [
            "id"        => [ 'type' => 'int(11)', 'null' => 'NOT NULL', 'inc' => true ],
            "parent"    => [ 'type' => 'varchar(150)', 'null' => 'NOT NULL' ],
            "patch"     => [ 'type' => 'varchar(150)', 'null' => 'NOT NULL' ],
            "md5"       => [ 'type' => 'varchar(50)', 'null' => 'NOT NULL' ],
            "parentmd5" => [ 'type' => 'varchar(50)', 'null' => 'NOT NULL' ],
            "serverid"  => [ 'type' => 'int(15)', 'null' => 'NOT NULL' ],
        ];
    ...
    private function file_force_download($file, $infilename, $delfile)
    {
        if (file_exists($file))
        {
            // сбрасываем буфер вывода PHP, чтобы избежать переполнения памяти выделенной под скрипт
